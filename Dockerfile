...
RUN wget https://raw.githubusercontent.com/stanfordnlp/stanza-resources/master/resources_1.1.0.json -P ~/stanza_resources \
    wget https://nlp.stanford.edu/software/stanza/1.1.0/nb/default.zip -P ~/stanza_resources/nb \
    unzip ~/stanza_resources/nb/default.zip -d ~/stanza_resources/nb/ \
    rm ~/stanza_resources/nb/default.zip \
    mv ~/stanza_resources/resources_1.1.0.json ~/stanza_resources/resources.json
